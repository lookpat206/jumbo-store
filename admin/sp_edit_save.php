...
if (isset($_POST['pl_id'], $_POST['sp_id'], $_POST['u_id'], $_POST['quantity'], $_POST['sp_price'], $_POST['sp_status'])) {
    ...
    $result = sp_list_edit($pl_id,  $sp_id, $u_id, $quantity, $sp_price, $sp_status);
